...
if( ! class_exists( 'avia_form', false ) )
{
...
//				$label = '';
		...
		protected function datepicker( $id, array $element )
		{
			...
			$this->elements_html .= "<p class='{$p_class} {$element['class']}' id='element_$id'>";
			$form_el = ' <input name="' . $id . '" class="avia_datepicker text_input ' . $element_class.'" type="text" id="' . $id . '" value="' . $value . '" placeholder="' . $placeholder . '" inputmode="none" />';
			$label = '<label for="' . $id . '">' . $element['label'] . $required . '</label>';
