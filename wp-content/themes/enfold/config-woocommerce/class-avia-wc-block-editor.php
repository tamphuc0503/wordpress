...
if( ! class_exists( 'Avia_WC_Block_Editor', false ) )
{
	class Avia_WC_Block_Editor
	{
		...
		public function handler_wp_register_scripts()
		{
			...
			wp_register_style( 'avia_wc_blocks_admin_css', "{$template_url}/config-woocommerce/admin/woo-admin-blocks{$min_css}.css", array( 'avia-modal-style', 'avia-builder-style', 'avia_gutenberg_css' ), $vn );
