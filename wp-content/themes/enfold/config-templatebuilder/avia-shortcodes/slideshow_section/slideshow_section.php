		...
		function popup_elements()
		{
			...
			$this->elements = array(
				...
				array(
					...
					array(
							'name' 	=> __( 'ELEMENT IN ACTIVE BETA since 5.6.5', 'avia_framework' ),
							'desc' 	=> __( 'Please check the frontend when using animations or elements such as the Lottie Animation in slide content. Slide transitions might break element behaviour.', 'avia_framework' ),
							'type' 	=> 'heading',
